...
const routes = [
  ...
  { path: '/loginRegister', name: 'LoginRegister', meta: { name: '登录注册' }, component: () => import('../views/LoginRegister.vue') },
  { path: '*', name: 'NotFound', meta: { name: '无法访问' }, component: () => import('../views/404.vue') },
  { path: '/test', name: 'test', meta: { name: '测试页面' }, component: () => import('../views/test.vue') },
]
