...
-- ----------------------------
-- Table structure for 3d_image
-- ----------------------------
DROP TABLE IF EXISTS `3d_image`;
CREATE TABLE `3d_image`  (
  ...
  `group_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '图片组类id',
...
-- Records of 3d_image
-- ----------------------------
INSERT INTO `3d_image` VALUES ('13', 'http://localhost:9090/files/1712223041051-a097bb7c67fcf50a85357b1fcd870c04.mp4', '你好帅', '321321', '13');
INSERT INTO `3d_image` VALUES ('13', '0', '12323', 'fdcc459b-d5a4-410f-90e3-162f35bd5de0', '100');
...
CREATE TABLE `ai`  (
  `Ai_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'AI对话的ID',
  `User_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户ID',
  `message` varchar(10000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户对话',
  `answer` varchar(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'AI回答',
...
-- Records of ai
-- ----------------------------
INSERT INTO `ai` VALUES ('21cd5996-645d-47e7-a433-d8427162918e', '13', '1+1=?', '1 + 1 equals 2.', '2024-04-03 23:23:54');
INSERT INTO `ai` VALUES ('24aff90a-b96f-43e4-be0d-033b03054287', '13', '如何学习c++', '学习C++可以遵循以下步骤和建议：\n\n1. **基础知识**：\n   - 首先，了解计算机编程的基本概念，如变量、数据类型、控制结构（条件语句、循环）和函数等。\n   - 学习C语言的基础，因为C++是建立在C语言之上的。\n\n2. **选择教材**：\n   - 选择一本好的C++入门书籍，例如《C++ Primer》、《Effective C++》或《C++编程语言特许版》（Bjarne Stroustrup著）。\n   - 网上也有许多免费的教程和课程，可以根据个人喜好选择。\n\n3. **动手实践**：\n   - 编写代码是学习编程的关键。从简单的程序开始，比如打印“Hello, World!”。\n   - 练习编写不同的小程序，如计算器、简单的游戏等，以加深对语言的理解。\n\n4. **理解面向对象编程**：\n   - C++是支持面向对象编程的，所以要学习类、对象、封装、继承和多态等概念。\n\n5. **深入学习**：\n   - 掌握C++的高级特性，如模板、STL（标准模板库）、异常处理和内存管理。\n   - 学习设计模式，这对于编写可维护和可扩展的代码至关重要。\n\n6. **阅读他人代码**：\n   - 分析和理解已有的C++代码可以帮助你学习新的编程技巧和最佳实践。\n\n7. **项目实践**：\n   - 参与实际项目，无论是个人项目还是开源项目，都能提升你的技能。\n   - 解决编程挑战，如LeetCode、HackerRank上的问题。\n\n8. **使用IDE和调试工具**：\n   - 使用集成开发环境（IDE），如Visual Studio、Code::Blocks、CLion等，它们提供了友好的编程界面和调试功能。\n   - 学习如何使用调试器来查找和修复错误。\n\n9. **持续学习**：\n   - 保持更新，学习C++的新标准，如C++11、C++14、C++17、C++20等。\n\n10. **社区参与**：\n    - 加入C++开发者社区，如Stack Overflow、Reddit的r/cpp等，提问和解答问题，分享知识。\n\n记得学习编程是一个渐进的过程，不要急于求成，不断练习和探索是提高的关键。', '2024-04-04 13:53:33');
INSERT INTO `ai` VALUES ('2fcb4382-be96-45d8-9171-c07d402bcca9', '13', '23', '23是一个数字。如果你需要关于23的更多信息，例如数学运算或相关事实，请提供更多的上下文。', '2024-04-04 17:59:59');
INSERT INTO `ai` VALUES ('6153acdb-aa3e-4dfa-a05f-7efe7a5f714a', '13', '334', '334是一个数字。如果你需要更多关于334的信息或者数学上的运算，请提供更多的上下文。', '2024-04-04 13:46:18');
INSERT INTO `ai` VALUES ('a1944b35-e296-4e91-ac84-d94a497e799f', '13', '1+1=?', '1 + 1 equals 2.', '2024-04-03 23:24:03');
INSERT INTO `ai` VALUES ('a93d14d1-cf48-4078-8271-2c4b8f7d37cc', '13', '你是什么人', '我是一个人工智能语言模型，由阿里云开发，被称为通义千问。我的主要任务是回答用户的问题、提供信息、进行对话和解决问题。你可以问我关于各种主题的问题，我会尽力给出最准确的答案。', '2024-04-04 13:37:03');
INSERT INTO `ai` VALUES ('a98e54ce-fdf4-4e69-b037-91fb6b89186c', '13', '1+1=?', '1 + 1 equals 2.', '2024-04-03 23:24:00');
INSERT INTO `ai` VALUES ('ac32cc08-44f3-451f-97f6-a6b8de985ecd', '13', '1+1', '1 + 1 equals 2.', '2024-04-04 18:00:15');
INSERT INTO `ai` VALUES ('ac34ad5e-4282-4c77-8bd9-376f9413a181', '13', '什么是12', '12 是一个自然数，位于数字11和13之间。在十进制系统中，它是一个偶数，可以被1、2、3、4、6和12整除。12在文化中有着多种意义，例如：\n\n- 在时钟上，12表示一天中的小时之一（午夜或正午）。\n- 一年有12个月。\n- 中国的十二生肖中有12种动物代表不同的年份。\n- 西方占星学中有12星座。\n- 在某些传统中，12被视为一个完整的数字，象征完美或完整，比如耶稣的12门徒。\n- 计算机键盘和电话上通常有12个数字键。\n- 苹果公司曾推出过iPhone 12系列智能手机。\n\n这些都是12在不同领域的一些常见含义。如果你需要更具体的数学信息或者其他方面的解释，请告诉我。', '2024-04-04 18:15:09');
INSERT INTO `ai` VALUES ('bcbd09e1-2d65-434c-b86b-630e1daa296c', '13', '1+1=?', '1 + 1 equals 2.', '2024-04-03 23:23:58');
INSERT INTO `ai` VALUES ('ccf09a36-032c-4d2b-ad8d-5d9f1b2ad225', '13', '草泥马', '“草泥马”在网络中通常是一种恶搞的用语，源自对“槽你妈”的谐音，但在实际中指的是一种动物，即羊驼。羊驼是南美洲的一种哺乳动物，外形类似骆驼，但体型较小，有长颈和长毛。它们通常被饲养为宠物或用于生产毛织品。请根据上下文理解其含义。', '2024-04-03 23:23:25');
INSERT INTO `ai` VALUES ('d8af1dd5-0ef6-4b55-af60-780d753b20ca', '13', '12', '12是一个数字。如果你需要关于12的更多信息，例如数学运算或相关事实，请提供更多的上下文。', '2024-04-04 14:04:13');
INSERT INTO `ai` VALUES ('e49b366a-0efc-4542-8066-a62a0372f2f7', '13', '1+1=?', '1 + 1 equals 2.', '2024-04-03 23:24:01');
...
CREATE TABLE `collect`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 52 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '收藏' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `collect` VALUES (51, 11, 13, '活动');
...
CREATE TABLE `comment`  (
  ...
  `module` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '模块',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '评论表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of comment
-- ----------------------------
INSERT INTO `comment` VALUES (31, '试试', 13, NULL, 31, '2024-04-05 00:19:57', 33, '博客');
INSERT INTO `comment` VALUES (32, '', 13, NULL, 32, '2024-04-05 00:41:34', 33, '博客');
INSERT INTO `comment` VALUES (34, '你好', 13, NULL, 34, '2024-04-05 00:47:09', 35, '博客');
...
CREATE TABLE `likes`  (
  ...
  `module` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '模块',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 67 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '点赞' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `likes` VALUES (66, 11, 13, '活动');
...
CREATE TABLE `t_video_info`  (
  `id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '自增id',
...
-- ----------------------------
INSERT INTO `t_video_info` VALUES ('112', 'Echarts效果图', '2022-04/25/1049369248.mp4', '2022-04/25/1049369356.jpg', '2022-04-13 12:00:00', '2022-04-25 10:49:36', NULL);
INSERT INTO `t_video_info` VALUES ('89', 'Nginx', '2022-04/23/2105539543.mp4', '2022-04/23/2105559039.jpg', '2022-04-22 12:00:00', '2022-04-23 21:05:53', NULL);
INSERT INTO `t_video_info` VALUES ('93', '效果图', '2022-04/23/2109329013.mp4', '2022-04/23/2109329372.jpg', '2022-04-13 12:00:00', '2022-04-23 21:09:31', NULL);
INSERT INTO `t_video_info` VALUES ('95', '我爱你不问归期', '2022-04/23/2115109741.mp4', '2022-04/23/2115109188.jpg', '2022-04-05 12:00:00', '2022-04-23 21:14:42', NULL);
INSERT INTO `t_video_info` VALUES ('98', '辞九门回忆', '2022-04/23/2117439355.mp4', '2022-04/23/2117439203.jpg', '2022-04-13 12:00:00', '2022-04-23 21:17:17', NULL);
...
CREATE TABLE `user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户信息' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `user` VALUES (13, 'bei1', '123', 'bei1', 'http://localhost:9090/files/1712244123206-1697438073596-avatar.png', 'USER', NULL, '15528023790', ' tingqingzhang90@gmail.com', '我是大v快关注我', '2024-02-14');
INSERT INTO `user` VALUES (14, 'r1', '123', 'r1', NULL, 'USER', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES (20, 'beishan', '123', 'beishan', 'http://localhost:9090/files/1711125128451-th.jpg', 'USER', NULL, NULL, NULL, NULL, NULL);
